...
#### Synopsis:
A moment ($M$) measures an object's tendency to rotate. This would be the equivalent to a force, but in a rotational motion. Usually a distinguishment is made between moments and [torques](Torque) but physically they act the same on an object. A moment either __1:__ bends the object, or __2:__ is a rotation caused by forces over a distance.
