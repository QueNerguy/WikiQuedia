...
In this process the head moves in the horizontal plane, and the table moves the [workpiece](Manufacturing%20Technologies%20Overview#Terms%20and%20Disambiguation) up and down[^jet1].
##### Similar Processes
This process is similar to [binder jetting](binder%20jetting), where metals, polymers and ceramics can all be used and the material isn't cured but instead is held together by an adhesive.
### Characteristics
