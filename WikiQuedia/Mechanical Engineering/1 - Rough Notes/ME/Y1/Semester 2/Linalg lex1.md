...
- Rules of computation:
	...
	3. multiplication of a row means multiplication of the determinant by that value. (you have to divide by the multiplier in the end to reach the actual determinant)
	4. $\det\left(A\right)\cdot\det\left(B\right)=\det\left(AB\right)$ 
	5. $\det\left(A\right)=\det\left(A^{T}\right)$, therefore row and column operations have the same 4 previously mentioned rules.
