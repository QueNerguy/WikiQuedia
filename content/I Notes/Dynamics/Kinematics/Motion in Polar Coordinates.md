...
$$
\vec{\textbf{v}} = \begin{bmatrix} v_r \\ v_\theta \end{bmatrix} = \frac{d}{dt} \left[ s_r \hat{\textbf{e}}_r \right]
$$
$$
\vec{\textbf{v}} = \begin{bmatrix} v_r \\ v_\theta \end{bmatrix} = \dot{s}_r \hat{\textbf{e}}_r + s_r \dot{\hat{\textbf{e}}}_r
$$
...
$$
\vec{\textbf{v}} = \begin{bmatrix} v_r \\ v_\theta \end{bmatrix} = \dot{r} \hat{\textbf{e}}_r + r \dot{\theta} \hat{\textbf{e}}_\theta
$$
#### Acceleration
To find the acceleration we take the [derivative](Differentiation) of the velocity.
$$
\vec{\textbf{a}} =  \begin{bmatrix} a_r \\ a_\theta \end{bmatrix} = \frac{d}{dt} \left[ \vec{\textbf{v}} \right] = \frac{d}{dt} \left[ \dot{r} \hat{\textbf{e}}_r + r \dot{\theta} \hat{\textbf{e}}_\theta \right]
$$
$$
\vec{\textbf{a}} = \begin{bmatrix} a_r \\ a_\theta \end{bmatrix} = \ddot{r}\hat{\textbf{e}}_r + \dot{r} \dot{\hat{\textbf{e}}}_r + \dot{r} \dot{\theta} \hat{\textbf{e}}_\theta + r \ddot{\theta} \hat{\textbf{e}}_\theta + r \dot{\theta} \dot{\hat{\textbf{e}}}_\theta 
$$
...
$$
\vec{\textbf{a}} = \begin{bmatrix} a_r \\ a_\theta \end{bmatrix} = \ddot{r}\hat{\textbf{e}}_r + \dot{r} \left( \dot{\theta}\hat{\textbf{e}}_\theta \right) + \dot{r} \dot{\theta} \hat{\textbf{e}}_\theta + r \ddot{\theta} \hat{\textbf{e}}_\theta + r \dot{\theta} \left( - \dot{\theta} \hat{\textbf{e}}_r \right) 
$$
