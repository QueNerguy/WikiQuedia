...
$$
\vec{\textbf{v}}(v_n, v_t) = \begin{bmatrix} 0 \\ v_t \end{bmatrix} = \rho \dot{\beta} \hat{\textbf{e}}_t
$$
#### Acceleration
...
$$
\vec{\textbf{a}}(a_n, a_t)  = \dot{v}\hat{\textbf{e}}_t + v \dot{\beta} \hat{\textbf{e}}_n
$$
...
$$
\vec{\textbf{a}}(a_n, a_t)  = \dot{v}\hat{\textbf{e}}_t + \frac{v^2}{\rho} \hat{\textbf{e}}_n
$$
...
> $$
> $$
> \vec{\textbf{a}}(a_n, a_t)  = \begin{bmatrix} a_n \\ a_t \end{bmatrix} = \dot{v}\hat{\textbf{e}}_t + \frac{v^2}{\rho} \hat{\textbf{e}}_n
> $$
