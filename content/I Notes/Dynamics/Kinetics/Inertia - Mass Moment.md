...
| ![[MassInertiaRod_80.png]]                   | Long **rod** with a **rotation** around any axis at the end of the rod.<br>**Note** that the thickness of the rod itself is assumed to be insignificant.<br>__Note__ that the $\sin(\alpha )$ term disappears for a rotation along the center axis. | $$I = \frac{1}{3}mL^2 \sin^2(\alpha)$$                                  |
