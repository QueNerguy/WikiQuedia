...
1. ***[Homogeneous Ordinary Differential Equations](#Homogeneous%20Equations)*** -> this js means $ay^" + by' + cy = 0$
2. ***[Non-Homogeneous Ordinary Differential Equations](#Non-Homogeneous%20Equations)*** -> this js means $ay^" + by' + cy = d$
...
$$
This equation is known as **the characteristic equation**. <br>In the case of our equation $3y^" + 6y' + 5 y = 0$, we would solve the characteristic equation $3 \lambda^2 + 6\lambda + 5 = 0$.
$$
...
2. Substituting $\lambda$ into the general solution for $y$. 
	- In the case of **two roots**: $$y = c_1 e^{\lambda_1 t} + c_2 e^{\lambda_2 t}$$
