...
# MAG and MIG Welding
### Process
 <u>M</u>etal <u>A</u>ctive <u>G</u>as and <u>M</u>etal <u>I</u>nert <u>G</u>as welding are welding processes that use a consumable electrode to create [plasma](Plasma%20Working.md) upon contact with the [workpiece](!%20Manufacturing%20Technologies%20Overview.md#Terms%20and%20Disambiguation). This plasma melts the metal locally, allowing for great precision. A coating is formed by the gas on the weld to protect it form reacting with the atmosphere. Depending on the metal type a different gas is used. Inert gases like helium are used for non-ferrous metals, but for ferrous metals like steels carbon based gases are used because they can penetrate the weld better allowing for better corrosion resistance[^magmig].
##### Similar Processes
...
---
# Based On:
[^magmig]: Wikipedia, _Gas metal arc welding_, [link](https://en.wikipedia.org/wiki/Gas_metal_arc_welding).
...
3. Wikipedia, _Gas metal arc welding_, [link](https://en.wikipedia.org/wiki/Gas_metal_arc_welding).