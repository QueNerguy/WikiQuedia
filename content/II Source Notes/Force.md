...
#### Synopsis:
A force, $F$, measures the tendency of an object or point to move in a straight line. A $0$ force means there's no acceleration, so the object either doesn't move, or moves at a constant speed. Statically these situations are equivalent.
