...
[^pattern]: Wikipedia, _Pattern (casting)_, [link](https://en.wikipedia.org/wiki/Pattern_(casting)).
[^die]: Wikipedia, _Die (manufacturing)_, [link](https://en.wikipedia.org/wiki/Die_(manufacturing)).